require File.dirname(__FILE__) + "/test_i_setup" unless defined? TestISetup
require "test/unit"

class TestI < Test::Unit::TestCase
  include TestISetup
  ...
  def test_001
	  ...
	  assert_equal "Critical",get_text($result_index_xpath["module_rule_level"]+"[3]/th")
		...
		#sample_cpp/Common/src
		assert_equal "Critical",get_text($result_index_xpath["module_rule_level"]+"[11]/th")
		assert_equal "High",get_text($result_index_xpath["module_rule_level"]+"[12]/th")
		assert_equal "Normal",get_text($result_index_xpath["module_rule_level"]+"[13]/th")
  	#everyfile title
  ...
  def test_002
  	...
  	assert_equal 9, get_xpath_count($result_index_xpath["module_row_count"])
  end
  ...
  def test_006
  	...
  	#sample_cpp/Common/src
  	wait_for_element_present($result_index_xpath["link_under_module"]+"[11]/td[1]/a")
  	wait_for_element_present($result_index_xpath["link_under_module"]+"[12]/td[1]/a")
  	wait_for_element_present($result_index_xpath["link_under_module"]+"[13]/td[1]/a")
  	#dead link not started
  end
  ...
  def test_008
  	...
  	#sample_cpp/Common/src
  	link_count = 21
  	1.upto(link_count) do  |i|
  		wait_for_element_present($result_index_xpath["link_under_file_sample_cpp/Common/src"]+"[#{i}]/a")
  	end
  	#dead link not started
  end
  ...
  def test_016
  	...
  	wait_for_text_present("#{_("Analysis Result")}(#{_("Source")})")
  	#link to suitable page
  end
  ...
  def test_017
  	...
  	wait_for_text_present($title["analysis_result"])
  	#link to source page
  	click $result_index_xpath["link_under_file_sample_c/src"]+"[4]/a"
