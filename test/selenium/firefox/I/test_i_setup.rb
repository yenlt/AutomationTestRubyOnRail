...
$xpath = {
	...
	"result_index_page_link"						=>	"//div[@id='main_area']/table[@id='tab_contents']/tbody[2]/tr/td[@id='task_detail_window']/div[@id='task_detail']/table/tbody/tr[4]/td[3]/table/tbody[@id='log_and_result']/tr[2]/td[5]/a"
}
...
$result_index_xpath = {
	...
	"link_under_file_sample_cpp/Common/src"					=>	"//div[@id='main_area']/div/ul[3]/li"	
}
...
$critical_source	=	{
	"critical_page_title"											=>	"#{_("Analysis Result")}(LanguageFactory.cpp.Critical.html)\n#{_("Analysis Task")}1:「sample_c_cpp_1_1」,#{_("Tool")}:「QAC++」",
	"link_to_view_message_page"								=>	"//div[@id='main_area']/b[1]/a"
}	

$view_message	=	{
	"next_message"														=>	"//img[@alt='[次へ]']",					
	"previous_message"												=>	"//img[@alt='[前へ]']",
...
$view_misc	=	{
	...
	#"link_to_view_misc_page"									=>	"//div[@id='main_area']/table[2]/tbody/tr/td[2]/a[2]",
	"link_to_view_misc_page"									=>	"link=#{_("Personality")} #{_("Group")}",
	"view_misc_page_title"										=>	"QA C++ #{_("Help")} - #{_("Personality")} #{_("Group")} #{_("Index")}"
}		
